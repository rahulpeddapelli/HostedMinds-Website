...
export default function LandingComponent() {
    ...
    return (
        <section className="text-gray-800 py-10 min-h-[calc(100vh-4.5rem) mb-10">
                    ...
                    <div className="mt-6 flex gap-6 justify-center lg:justify-start">
                        ...
                        <div className='w-1/3'>
                            <RotatingText
                                ...
                                mainClassName="px-2 sm:px-2 md:px-3 bg-[#69c] text-lg text-white font-bold overflow-hidden py-1 sm:py-2 md:py-2 justify-center rounded-lg"
                                staggerFrom={"last"}
                                initial={{ y: "100%" }}
                                animate={{ y: 0 }}
                                exit={{ y: "-120%" }}
